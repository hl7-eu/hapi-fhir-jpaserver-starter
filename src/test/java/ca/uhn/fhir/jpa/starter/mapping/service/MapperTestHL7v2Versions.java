	...
	void mapHL7v2ToFHIRVersions(String version) throws Exception {
		...
		String hl7v2Message = String.format(
			"MSH|^~\\&|HIS|RIH|EKG|EKG|199904140038||ADT^A01||P|%s\r" +
				"PID|0001||00001122||SMITH^JOHN^M|MOM|19581119|F|^LINDA^M|C|564 SPRING ST^^NEEDHAM^MA^02494^US||||E|S|C|0000444444|||||SA|||SA||||NONE|V1|0001||D.ER^50A^M110^01|ER|P00055|11B^M011^02|070615^BATMAN^GEORGE^L|555888^^BOB^K^DR^MD|^^SAM^T^DR^MD^PHD|ER|D.WT^1A^M010^01|||ER|AMB|02|070615^^BILL^L|ER|000001916994|D||||||||||||||||GDD|WA|NORM|02|O|02|E.IN^02D^M090^01|E.IN^01D^M080^01|199904072124|199904101200|199904101200||||5555112333|||666097^^MANNY^P\r" +
				"NK1|0222555|^JAMES^R|FA|STREET^OTHER STREET^CITY^ST^55566|||||||||ORGANIZATION",
			version
		);
