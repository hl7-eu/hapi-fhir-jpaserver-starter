...
public class Repositories {
	...
	public static Repository proxy(Repository data, Repository content, Repository terminology) {
		return new CohorteRepository(data, content, terminology);
	}
	...
	public static Repository proxy(Repository localRepository, Boolean useLocalData, IBaseResource dataEndpoint, IBaseResource contentEndpoint, IBaseResource terminologyEndpoint) {
		return dataEndpoint == null && contentEndpoint == null && terminologyEndpoint == null ? localRepository : new CohorteRepository(localRepository, useLocalData, createRestRepository(localRepository.fhirContext(), dataEndpoint), createRestRepository(localRepository.fhirContext(), contentEndpoint), createRestRepository(localRepository.fhirContext(), terminologyEndpoint));
	}
	...
	public static Repository proxy(Repository localRepository, Boolean useServerData, Repository dataRepository, Repository contentRepository, Repository terminologyRepository) {
		return dataRepository == null && contentRepository == null && terminologyRepository == null ? localRepository : new CohorteRepository(localRepository, useServerData == null ? Boolean.TRUE : useServerData, dataRepository, contentRepository, terminologyRepository);
	}
