...
//		}
//
//		DatamartExportation datamartExportation = new DatamartExportation(mappingEngine, repository);
//
//		Binary export = datamartExportation.exportDatamart(researchStudy, type, structureMapUrl);
//
//		return export;
//	}
}
