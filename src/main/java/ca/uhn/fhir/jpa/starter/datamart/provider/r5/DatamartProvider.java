...
public class DatamartProvider {
    ...
    public ListResource generateDatamart(
        ...
        return new DatamartService(new RestRepository(context.getRestfulClientFactory().newGenericClient(remoteUrl)), DatamartEvaluationOptions.defaultOptions()).generateDatamart(
                researchStudyUrl,
