...
public class CohorteRepository implements Repository {
	private static final Set<String> terminologyResourceSet = new HashSet(Arrays.asList("ValueSet", "CodeSystem", "ConceptMap"));
	private static final Set<String> researchResourceSet = new HashSet(Arrays.asList("Library", "EvidenceVariable", "ResearchStudy", "Group"));
	...
	public CohorteRepository(Repository local, Boolean useLocalData, Repository data, Repository research, Repository terminology) {
	...
	public CohorteRepository(Repository data, Repository research, Repository terminology) {
